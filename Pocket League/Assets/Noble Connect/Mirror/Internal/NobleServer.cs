...
#region Static NetworkServer Wrapper
        ...
        public static void Reset() { NetworkManager.singleton.StopServer(); NetworkManager.singleton.StartServer(); }
        ...
        {
            NetworkIdentity nId = new NetworkIdentity();
            NetworkServer.SendToClientOfPlayer<T>(nId, msg);
        }
        ...
        static public bool SpawnWithClientAuthority(GameObject obj, GameObject player) { NetworkServer.Spawn(obj, player); return true; }
        static public bool SpawnWithClientAuthority(GameObject obj, NetworkConnection conn) { NetworkServer.Spawn(obj, conn); return true; }
        static public bool SpawnWithClientAuthority(GameObject obj, Guid assetId, NetworkConnection conn) { NetworkServer.Spawn(obj, assetId, conn); return true; }
