...
{
    /// <summary>This is almost an exact copy of Mirror's LobbyPlayer but with a few changes so that it works with NobleNetworkLobbyManager</summary>
    ...
    public class NobleLobbyPlayer : NetworkBehaviour
    {
        ...
        public void Start()
        {
            if (NetworkManager.singleton is NobleNetworkLobbyManager room)
            {
        ...
        public void CmdChangeReadyState(bool readyState)
        {
            ...
            NobleNetworkLobbyManager room = NetworkManager.singleton as NobleNetworkLobbyManager;
            if (room != null)
            {
        ...
        void ReadyStateChanged(bool oldValue, bool newReadyState)
        {
