...
namespace NobleConnect.Mirror
{
    public class LobbyReadyToBeginMessage : MessageBase
    {
        ...
        public override void Serialize(NetworkWriter writer)
        {
            ...
            writer.WriteBoolean(readyState);
    ...
    public class NobleNetworkLobbyManager : NobleNetworkManager
    {
        ...
        [SerializeField]
        NobleLobbyPlayer roomPlayerPrefab;
        ...
        /// </summary>
        public List<NobleLobbyPlayer> roomSlots = new List<NobleLobbyPlayer>();
        ...
        internal void ReadyStatusChanged()
        {
            ...
            foreach (NobleLobbyPlayer item in roomSlots)
            {
                if (item != null)
                {
                    CurrentPlayers++;
        ...
        public override void OnServerReady(NetworkConnection conn)
        {
            ...
            if (conn != null && conn.identity != null)
            {
                ...
                if (roomPlayer != null && roomPlayer.GetComponent<NobleLobbyPlayer>() != null)
        ...
        public void CheckReadyToBegin()
        {
            ...
            if (minPlayers > 0 && NetworkServer.connections.Count(conn => conn.Value != null && conn.Value.identity.gameObject.GetComponent<NobleLobbyPlayer>().readyToBegin) < minPlayers)
            {
                allPlayersReady = false;
                return;
            }
        ...
        {
            OnRoomClientEnter();
            foreach (NobleLobbyPlayer player in roomSlots)
                if (player != null)
                {
        ...
        public override void OnServerDisconnect(NetworkConnection conn)
        {
            ...
            {
                NobleLobbyPlayer player = conn.identity.GetComponent<NobleLobbyPlayer>();
        ...
        public override void OnServerAddPlayer(NetworkConnection conn)
        {
            ...
            NobleLobbyPlayer newRoomPlayer = newRoomGameObject.GetComponent<NobleLobbyPlayer>();
        ...
        public override void ServerChangeScene(string sceneName)
        {
            ...
            {
                foreach (NobleLobbyPlayer roomPlayer in roomSlots)
                {
                    ...
                    if (NetworkServer.active)
                    {
                        ...
                        roomPlayer.GetComponent<NobleLobbyPlayer>().readyToBegin = false;
