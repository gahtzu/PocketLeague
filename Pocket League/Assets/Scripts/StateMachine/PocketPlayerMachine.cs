...
public class PocketPlayerMachine : StateMachine
{
    protected override void Initialize()
    {
        ...
        State chargeAttackRecovery = CreateState(PlayerState.ChargeAttackRecovery, LegalTransitions(new List<Enum>() { PlayerState.Actionable, PlayerState.Hitstun, PlayerState.BulletHitstun, PlayerState.Dead }));
        ...
        State swipeAttack = CreateState(PlayerState.SwipeAttack, LegalTransitions(new List<Enum>() { PlayerState.Actionable, PlayerState.Hitstun, PlayerState.Hitstun, PlayerState.Dead }));
        State teleport = CreateState(PlayerState.Teleport, LegalTransitions(new List<Enum>() { PlayerState.Actionable, PlayerState.Hitstun, PlayerState.Hitstun, PlayerState.Dead }));
